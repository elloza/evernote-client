package com.lozasolutions.evernoteclient.features.base;
...
import com.lozasolutions.evernoteclient.injection.component.ConfigPersistentComponent;
import com.lozasolutions.evernoteclient.injection.component.DaggerConfigPersistentComponent;
import com.lozasolutions.evernoteclient.injection.component.FragmentComponent;
        ...
        if (componentsArray.get(fragmentId) == null) {
            ...
            configPersistentComponent =
                    DaggerConfigPersistentComponent.builder()
                            .appComponent(EvernoteClientApplication.get(getActivity()).getComponent())
                            .build();
